...
export function FeatureCard({ icon, title, description, className }: FeatureCardProps) {
  return (
    <Card
      className={cn(
        'group hover:border-accent/50 transform hover:scale-[1.02] transition-all duration-500',
        className
      )}
    >
      <CardContent>
        <div className="flex flex-col gap-6">
          ...
          <div className="space-y-3">
            <CardTitle className="text-xl font-bold text-secondary group-hover:text-accent transition-colors duration-300">
              {title}
            </CardTitle>
