  ...
  return (
    ...
    >
      ...
      {!isLoading && showResult && (
        <div
          className={`flex flex-col gap-6 transition-opacity duration-300 ${fadeState === 'in' ? 'opacity-100' : 'opacity-0'}`}
        >
          <div className="flex flex-col gap-4 rounded-[20px] bg-[color:var(--color-surface-elevated)]/[0.15] p-8 backdrop-blur-sm">
          ...
          <Button
            onClick={handleReset}
            className="w-full rounded-2xl border-none bg-gradient-to-br from-[color:var(--color-primary)] to-[#c56647] px-5 py-6 font-ui text-lg font-semibold text-text-inverse shadow-[0_4px_20px_rgba(196,114,79,0.3),inset_0_1px_0_rgba(255,255,255,0.2)]"
          >
            Shorten Another URL
          </Button>
        </div>
